...
CREATE TABLE `grades` (
  ...
  UNIQUE KEY `grade_course_id_UNIQUE` (`grade_course_id`),
  UNIQUE KEY `grade_student_id_UNIQUE` (`grade_student_id`),
...
CREATE TABLE `courses` (
  ...
  CONSTRAINT `course_student_id` FOREIGN KEY (`course_student_id`) REFERENCES `students` (`student_id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8$$
